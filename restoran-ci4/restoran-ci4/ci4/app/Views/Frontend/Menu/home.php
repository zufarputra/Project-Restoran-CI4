...
<div class="container">
    <div class="row row-cols-1 row-cols-md-2">
        <?php foreach ($menus as $menu) : ?>
            <div class="col mb-4">
                <div class="card">
                    <img style="width:150px; heigh:100px;" src="<?= base_url('uploud/' . $menu['gambar'] . '') ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('front/cart/') ?>" method="POST">
                            ...
                            <button class="btn btn-primary mb-0" type="submit"> Add to Cart <i class="fas fa-check-square ml-2"></i></button>
                        </form>
                    </div>
                </div>
            </div>
